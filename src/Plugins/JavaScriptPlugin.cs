...
namespace Oxide.Core.JavaScript.Plugins
{
    ...
    public class JavaScriptPlugin : Plugin
    {
        ...
        public override void Load()
        {
            ...
            foreach (KeyValuePair<string, PropertyDescriptor> property in Class.GetOwnProperties())
            {
            ...
            foreach (KeyValuePair<string, PropertyDescriptor> property in Class.Prototype.GetOwnProperties())
            {
                ICallable callable = property.Value.Value?.TryCast<ICallable>();
                if (callable != null)
                {
